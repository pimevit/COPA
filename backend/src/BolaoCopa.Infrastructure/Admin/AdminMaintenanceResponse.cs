    ...
    int DeletedTeams)
{
    ...
    {
        return new AdminMaintenanceResponse(action, insertedTeams, updatedTeams, 0, 0, 0);
    }
    ...
    public static AdminMaintenanceResponse ApplicationDataReset(
        ...
        int deletedTeams)
    {
        return new AdminMaintenanceResponse(action, 0, 0, deletedBets, deletedMatches, deletedTeams);
    }
}
