...
public interface IBetRepository
{
    ...
    Task<bool> MatchExistsAsync(int matchId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Bet>> ListByUserAsync(int userId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Bet>> ListPublicAsync(int? matchId = null, CancellationToken cancellationToken = default);
